...
def assert_model_equals(model_instance: Base, expected_data: Dict[str, Any], exclude_keys: list[str] = None):
...
def create_test_models(db: Session, model: Type[Base], count: int, base_data: Dict[str, Any]) -> list[Base]:

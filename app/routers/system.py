...
from app.schemas.system import HealthCheck, ConfigResponse, ConfigSettings
...
@router.get(
    ...
    description="Returns the current system configuration including environment variables and settings.",
